...
namespace LogicSimulator.Views.Shapes
{
    public abstract class GateBase : UserControl
    {
        ...
        public GateBase()
        {
            ...
            if (canv.Children[0] is not Border b) throw new Exception("What's wrong?");
            border = b;
            border.ZIndex = 2;
...
#pragma warning restore CS0108
        ...
        public void SetJoinColor(int o_num, bool value)
        {
            ...
            { // Ох, знакомая головная боль с андроида, где даже Toast за пределами главного потока не вызовешь :/ XD :D
