...
#pragma warning disable IDE0051
        ...
        private string Export() {
            ...
            scheme.Created = 123;
            scheme.Modified = 456;
            return Utils.Obj2yaml(scheme.Export());
        }
        ...
        private static void SaveProject() {
            var proj = ViewModelBase.TopSecretGetProj() ?? throw new Exception("Отсутвует");
            proj.SetDir("../../..");
        ...
        private void ImportScheme(string data) {
            object yeah = Utils.Yaml2obj(data) ?? new Exception("Что-то не то в JSON");
